                    ...
                    total_data.append(
                        {
                            ...
                            "chosen_reward": golden_data["reward"],
                            "rejected_reward": explore_data["meta"]["reward"],
                            "from": "golden"
                        }
                    )
                elif explore_data["meta"]["reward"] > golden_data["reward"]:
                    for k in explore_data["conversations"]:
                        k["role"] = "user" if k["from"] == "human" else "assistant"
                        k.pop("from")
                        k["content"] = k.pop("value")
                    ...
                    total_data.append(
                        {
                            "id": id,
                            "conversations": golden_data["conversations"][:2],
                            "chosen": explore_data["conversations"][2:],
                            "rejected": golden_data["conversations"][2:],
                            "chosen_reward": explore_data["meta"]["reward"],
                            "rejected_reward": golden_data["reward"],
                            "from": "explore"
                        }
                    )
                break
